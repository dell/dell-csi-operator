...
// +kubebuilder:rbac:groups=storage.dell.com,resources=csipowerstores;csipowerstores/finalizers;csipowerstores/status,verbs=*
...
func (r *CSIPowerStoreReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	// your logic here
	csiPowerStore := &storagev1.CSIPowerStore{}
...
func (r *CSIPowerStoreReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	if err != nil {
		r.Log.Error(err, "Unable to setup CSIPowerStore controller")
		os.Exit(1)
	}

	err = c.Watch(
		&source.Kind{Type: &storagev1.CSIPowerStore{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		r.Log.Error(err, "Unable to watch CSIPowerStore Driver")
		os.Exit(1)
	}

	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &storagev1.CSIPowerStore{},
	})
	if err != nil {
...
func (r *CSIPowerStoreReconciler) GetConfig() operatorconfig.Config {
	return r.Config
}
...
func (r *CSIPowerStoreReconciler) SetConfig(c operatorconfig.Config) {
	r.Config = c
}
